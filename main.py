...
data_dir = 'dataset/velocidade_60'
...
for file in os.listdir(data_dir):
    ...
    rmse_measures[img_path] = ssim(test_img, resized_img)
    sre_measures[img_path] = ssim(test_img, resized_img)
    fsim_measures[img_path] = ssim(test_img, resized_img)
